...
-- it has passed is never aggregated. A new user's back-history is exactly that case â€”
-- their first sync uploads months of rows whose dates are already below the watermark â€”
...
-- rpc() call fails with a cache miss â€” and a swallowed error there looks identical to
